...
export const canisterId = process.env.SOCIAL_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./social.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the social canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./social.did.js")._SERVICE>}
 */
